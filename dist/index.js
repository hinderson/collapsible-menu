...
// Helpers
var isOverflowed = function isOverflowed(elem) {
    return elem.offsetWidth < elem.scrollWidth;
};

// Constructor
var CollapsibleMenu = function CollapsibleMenu(query) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    var $elem = typeof query === 'string' ? document.querySelector(query) : query;
    ...
    return { toggleMenu: toggleMenu, checkOverflow: checkOverflow };
};
